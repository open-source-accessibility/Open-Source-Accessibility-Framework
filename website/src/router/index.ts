...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      component: () => import("../views/FoundationalSkills.vue"),
    },
    {
      path: "/skills/workflow",
      name: "workflow-skills",
      component: () => import("../views/WorkflowSkills.vue"),
    },
    {
      path: "/skills/testing",
      name: "testing-skills",
      component: () => import("../views/TestingSkills.vue"),
    },
    {
      path: "/skills/community",
      name: "community-skills",
      component: () => import("../views/CommunitySkills.vue"),
    },
    {
      path: "/workflow-skills",
      redirect: "/skills/workflow",
    },
  ],
});
